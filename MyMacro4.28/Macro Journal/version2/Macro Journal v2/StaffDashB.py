...
class StaffDashB(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.protein_label = tk.Label(self, text="Total Protein:")
        self.protein_label.grid(row=3, column=0, padx=10, pady=5)
    ...
    def add_food(self):
        # Retrieve food name, calories, protein, total fats, and total carbs from entry fields
        ...
        # Validate input
        if food_name and food_calories and protein and fats and carbs:
            try:
                # Convert calories, protein, fats, and carbs to float
    ...
    def edit_food(self):
        ...
        if selected_index:
            ...
            protein = self.food_items[food_name]["protein"]
            ...
            self.protein_entry.insert(0, protein)
    ...
    def update_food(self, selected_food):
        # Retrieve updated food name, calories, protein, total fats, and total carbs
        food_name = self.name_entry.get()
        food_calories = self.calorie_entry.get()
        protein = self.protein_entry.get()
        fats = self.fats_entry.get()
