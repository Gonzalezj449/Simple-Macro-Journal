...
class LoginPage(tk.Frame):
    ...
    def create_widgets(self):
        ...
        login_button = tk.Button(self, text="Log In", command=self.login, font=("Arial", 16))
        ...
        create_account_button = tk.Button(nav_frame, text="Create Account", command=lambda: self.controller.show_page("CreateAccountPage"), font=("Arial", 16))
        create_account_button.pack(side=tk.LEFT, padx=10)
        staff_login_button = tk.Button(nav_frame, text="Staff Login", command=lambda: self.controller.show_page("StaffLoginPage"), font=("Arial", 16))
