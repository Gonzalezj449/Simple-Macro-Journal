...
class DoctorLogin(tk.Frame):
    ...
    def create_widgets(self):
        ...
        login_button = tk.Button(self, text="Healthcare Log In", command=self.staff_login, font=("Arial", 16))
    ...
    def staff_login(self):
        ...
        if username == "doctor" and password == "password":
            self.login_message_label.config(text="Healthcare login successful")
            self.controller.show_page("DocDashB")
        else:
